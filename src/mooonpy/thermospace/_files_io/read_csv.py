# # This was broken when I found it. Commenting out until fixed:
# # TODO: @Tristan
# #  add case for "elif not line[0].isdigit():  # single check is cheaper than 5"
#
# from typing import Union
# import warnings
# from mooonpy import Path, Thermospace
# from mooonpy.tools import _col_convert
#
# def readcsv_basic(file: Union[str, Path], silence_error_line: bool=False) -> Thermospace:
...
#                 print("This code is unfinished. See mooonpy.tools._files_io.readcsv_basic")
#                 quit()
#
#             ## Read thermo section
